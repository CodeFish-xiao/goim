...
var (
	_emptyTops = make([]*model2.Top, 0)
)

// OnlineTop get the top online.
func (l *Logic) OnlineTop(c context.Context, typ string, n int) (tops []*model2.Top, err error) {
...
func (l *Logic) OnlineRoom(c context.Context, typ string, rooms []string) (res map[string]int32, err error) {
	...
	for _, room := range rooms {
		res[room] = l.roomCount[model2.EncodeRoomKey(typ, room)]
	}
	return
}
